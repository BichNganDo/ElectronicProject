...
public class AddCategoryNewsServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.getWriter().println(PageGenerator.instance().getPage("admin/category_news/add_cate_news.html", pageVariables));
