package servlets.admin.register;
...
public class ManageUserRegisterServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.getWriter().println(PageGenerator.instance().getPage("admin/register/manage_user_register.html", pageVariables));
