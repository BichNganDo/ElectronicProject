...
public class EditUserRegister extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.getWriter().println(PageGenerator.instance().getPage("admin/register/edit_user_register.html", pageVariables));
