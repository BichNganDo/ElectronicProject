package servlets.admin.email_register;
...
public class ManageEmailServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.getWriter().println(PageGenerator.instance().getPage("admin/email_register/manage_email.html", pageVariables));
