package servlets.admin.cate_product;
...
public class ManageCategoryProductServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.getWriter().println(PageGenerator.instance().getPage("admin/category_product/manage_cate_product.html", pageVariables));
